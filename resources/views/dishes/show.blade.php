  ...
  <div class="container py-5">
    ...
    <form method="POST" action="{{ route('order.add', ['dish' => $dish->dishes_id]) }}">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-5">
          @if ($dish->image)
            <img src="{{ asset('assets/images/termekek/' . $dish->image) }}" class="img-fluid rounded shadow-sm mb-3"
              alt="{{ $dish->name }}">
          @endif
            ...
            <div class="mb-3">
              ...
              @foreach ($extras as $extra)
                ...
                <div class="form-check">
                  <input class="form-check-input extra-ingredient" type="checkbox" name="extra_ingredients[]"
                    value="{{ $extra }}" data-price="{{ $gross }}">
          ...
          @if ($dish->base_ingredients)
            ...
            <div class="mb-3">
              ...
              @foreach ($ingredients as $ingredient)
                ...
                @endphp
                <div class="form-check">
                  <input class="form-check-input excluded-ingredient" type="checkbox" name="excluded_ingredients[]"
                    value="{{ $ingredient }}" data-price="{{ $gross }}">
                  <label class="form-check-label">
                    {{ $ingredient }}
                    @if ($discount != 0)
