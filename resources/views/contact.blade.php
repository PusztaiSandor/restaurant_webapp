...
@section('content')
  ...
  <section class="container mx-auto px-4 py-16 text-center pt-3">
    ...
    <p class="fs-5 text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mt-3">
      Ez a webalkalmazás oktatási céllal készült a Budapesti Műszaki Szakképzési Centrum Verebély László Technikum
      diákjainak vizsgaremekeként.
    </p>
    <p class="fs-5 text-xl font-semibold text-amber-700 mt-4">
  ...
  <section class="container mx-auto px-4 py-8 text-center pt-4">
    ...
    <p class="fs-5 text-lg text-gray-700 mb-6">1139 Budapest, Üteg utca 13-15.</p>
    <div class="w-full max-w-4xl mx-auto mb-8">
      <iframe src="https://www.google.com/maps?q=1139+Budapest,+Üteg+utca+13-15&output=embed" width="100%"
  ...
  <section class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 m-5">
      @foreach ([['name' => 'Győri Hajnal Csillag', 'image' => 'gyori.jpg', 'role' => 'UX/UI tervezés és felhasználói élmény tesztelés'], ['name' => 'Lednyiczki Richárd', 'image' => 'lednyiczki.jpg', 'role' => 'Frontend fejlesztés és UI logika tesztelés'], ['name' => 'Pusztai Sándor', 'image' => 'pusztai.jpg', 'role' => 'Backend fejlesztés és adatbázis tervezés, integrációk tesztelése']] as $creator)
        <div class="text-center">
          <img src="{{ asset('assets/images/keszitok/' . $creator['image']) }}" alt="{{ $creator['name'] }}"
    ...
    <div class="overflow-x-auto">
      <table class="table-auto mx-auto w-full max-w-4xl text-left ">
        <tbody class="text-gray-900">
          <tr>
            <td class="fs-5 px-4 py-2 font-semibold">Baranyi Péter</td>
            <td class="fs-5 px-4 py-2">Informatikai és távközlési alapok I-II., IKT projektmunka I.,
            Adatbázis-kezelés I., Szoftvertesztelés</td>
          </tr>
          <tr>
            <td class="fs-5 px-4 py-2 font-semibold">Faludi Anita</td>
            <td class="fs-5 px-4 py-2">Programozási alapok, Webprogramozás, Adatbázis-kezelés II., Frontend</td>
          </tr>
          <tr>
            <td class="fs-5 px-4 py-2 font-semibold">Fertály Zita</td>
            <td class="fs-5 px-4 py-2">Szakmai angol</td>
          </tr>
          <tr>
            <td class="fs-5 px-4 py-2 font-semibold">Horváth Attila</td>
            <td class="fs-5 px-4 py-2">Backend</td>
          </tr>
          <tr>
            <td class="fs-5 px-4 py-2 font-semibold">Juhász Zoltán</td>
            <td class="fs-5 px-4 py-2">Asztali és mobil alkalmazások fejlesztése és tesztelése, IKT projektmunka II.
            </td>
          </tr>
          <tr>
            <td class="fs-5 px-4 py-2 font-semibold">Somogyi Erika</td>
            <td class="fs-5 px-4 py-2">Asztali alkalmazások fejlesztése</td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  @if (!auth()->check() || auth()->user()->role === 'user')
    <section class="container mx-auto px-4 py-12 pt-2">
        ...
        <form method="POST" action="{{ route('contact.send') }}" class="mx-auto pt-5 fs-5" style="max-width:600px;">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="subject" name="subject" class="form-control"
              placeholder="Pl. Kérdés, javaslat, dicséret" maxlength="150">
            <small class="form-text text-muted">
          ...
          <div class="mb-3">
            ...
            <textarea id="content" name="content" class="form-control" rows="5"
              placeholder="Írd meg az üzeneted vagy értékelésed" required minlength="10" maxlength="1000"></textarea>
            <small class="form-text text-muted">
              Kötelező mező. Legalább 10, legfeljebb 1000 karakter. HTML, szkript és speciális karakterek nem
              engedélyezettek.
            </small>
          </div>
      ...
      @else
        ...
        <p class="fs-5 text-center text-gray-700 mt-4">
          Az értékeléshez és visszajelzéshez kérlek
          <a href="{{ route('login') }}" class="fs-5 text-amber-700 hover:underline">jelentkezz be</a>.
        </p>
      @endif
    </section>
  @endif
