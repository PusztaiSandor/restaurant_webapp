      ...
      <table class="table-auto mx-auto w-full max-w-4xl text-left">
        <tbody class="text-gray-700">
          <tr>
            ...
            <td class="px-4 py-2">Informatikai és távközlési alapok I-II., IKT projektmunka I.,
          ...
          <tr>
            ...
            <td class="px-4 py-2">Asztali és mobil alkalmazások fejlesztése és tesztelése, IKT projektmunka II.
            </td>
          </tr>
          <tr>
