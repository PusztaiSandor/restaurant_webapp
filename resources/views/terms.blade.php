...
<section class="container py-5 text-center">
    ...
    <div class="text-start mx-auto" style="max-width: 900px;">
        ...
        <p>
            Az alkalmazás forráskódja, struktúrája, dizájnja és tartalma a készítők szellemi tulajdonát képezik. <strong>Oktatási célokra</strong> az alkalmazás és annak forráskódja <strong>szabadon, korlátozás nélkül</strong> felhasználható bármely oktatási intézmény, tanuló vagy oktató által. A felhasználás nem igényel előzetes engedélyt, amennyiben nem történik vele kereskedelmi tevékenység.
        </p>
        <p>
            A forráskód felhasználása során kérjük, hogy a készítők és az eredeti intézmény neve (BMSZC Verebély László Technikum)
        ...
        <p>
            Az oldal nem gyűjt és nem tárol személyes adatokat kereskedelmi céllal. Minden adatkezelés kizárólag az oktatási
        ...
        <p>
            Az oldal fejlesztése 2025-ben történt, statikus és tantermi demonstrációs célokra. Az alkalmazás a Laravel keretrendszerben készült, PHP 8.2+ és MySQL/MariaDB adatbázis környezetben működik. A hosszú távú működés vagy támogatás nem garantált.
        </p>
    </div>
