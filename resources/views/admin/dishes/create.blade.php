      ...
      <div class="row mb-3">
        <div class="col-md-4">
          ...
          <input type="number" name="gross_price" id="gross_price" class="form-control" required min="0"
            step="0.01" value="{{ old('gross_price') }}">
        </div>
        <div class="col-md-4">
          ...
          <input type="number" name="tax_percent" id="tax_percent" class="form-control" min="0" max="100"
            step="0.01" value="{{ old('tax_percent', '27.00') }}">
        </div>
        <div class="col-md-4">
          ...
          <input type="number" name="discount_percent" id="discount_percent" class="form-control" min="0"
            max="100" step="0.01" value="{{ old('discount_percent', '0.00') }}">
        </div>
      </div>
          ...
          @foreach ($defaultSizes as $index => $size)
            <tr>
              <td><input type="text" name="size_labels[]" class="form-control text-center"
                  value="{{ old('size_labels.' . $index, $size) }}"></td>
              <td><input type="text" name="size_units[]" class="form-control text-center" placeholder="pl. cm, dl"
                  value="{{ old('size_units.' . $index) }}"></td>
              <td><input type="number" name="size_amounts[]" class="form-control text-center" min="0"
                  step="0.01" value="{{ old('size_amounts.' . $index) }}"></td>
              <td><input type="number" name="size_multipliers[]" class="form-control text-center" step="0.01"
                  value="{{ old('size_multipliers.' . $index, 1.0) }}"></td>
            </tr>
          @endforeach
        </tbody>
      </table>
