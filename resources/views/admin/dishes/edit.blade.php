...
{{-- Akciós állapot kiválasztása --}}
        ...
        <table class="table table-bordered align-middle">
            ...
            <tbody>
                ...
                @for ($i = 0; $i < max(3, count($labels)); $i++)
                    ...
                    @endphp
                    <tr>
                        <td><input type="text" name="size_labels[]" class="form-control text-center" value="{{ old('size_labels.' . $i, $label) }}"></td>
        ...
        <small class="text-muted">(Kicsi, Normál, Nagy) A nem kitöltött sorok figyelmen kívül lesznek hagyva mentéskor.</small>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="stock" id="stock" class="form-control" min="0" step="1" required
                    value="{{ old('stock', $dish->stock) }}">
            </div>
        </div>
